...
// WP-Optimize advanced-cache.php (written by version: 3.5.0) (homeurl: http://localhost/technovation24/) (abspath: C:\xampp\htdocs\technovation24/) (do not change this line, it is used for correctness checks)
...
$possible_plugin_locations = array(
	...
	'C:\xampp\htdocs\technovation24\wp-content\plugins\wp-optimize\cache',
);
...
if (false === $plugin_location) {
	...
	if (strcasecmp('http://localhost/technovation24/', $protocol . '://' . $host . $request_uri) === 0) {
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', 'C:\xampp\htdocs\technovation24\wp-content\plugins\wp-optimize\cache/extensions');
}
